...
class sreElastic:
    ...
    def _request(self, url: str, method: str = "get", params: Optional[Dict[str, Any]] = None):
        ...
        _url = f'http://{self.host.rstrip("/").lstrip("https://")}/{url.lstrip("/")}'
    ...
    """
        ...
        replica = {"index.number_of_replicas": amount - 1}
    ...
    """
        setting = {"index.routing.allocation.total_shards_per_node": number}
